...
> Thank You Being Member This Group.`,
                    ...
                    /* ...(await prepareWAMessageMedia({
                        video: {url: action === "add"
                          ? `https://files.catbox.moe/f994fm.mp4`
                          : `https://files.catbox.moe/ekit1e.mp4`, },
    ...
    upload: conn.waUploadToServer
           ...
           buttons: [
             {
                "name": "quick_reply",
                "buttonParamsJson": "{\"display_text\":\"Kartu Intro\",\"id\":\".intro\"}"
              },
              {
                "name": "quick_reply",
                "buttonParamsJson": "{\"display_text\":\"Daftar\",\"id\":\".verify\"}"
              },
              {
                "name": "quick_reply",
