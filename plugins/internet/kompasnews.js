...
let handler = async (m, {
    ...
    try {
        ...
        const res = await fetch('https://api.alfixd.my.id/api/kompasnews');
        const {
            status,
            source,
            result
        ...
        let newsList = `📰 *KOMPAS NEWS UPDATE* 📰\n`;
